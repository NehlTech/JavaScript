...
console.log(0.1 + 0.2); // Output: 0.30000000004
...
/**
 * Parsing
 * This reads the number from a string
 * It takes a second parameter thus the base
 */
console.log(Number.parseInt("30px", 10)); // Output: 30
console.log(Number.parseInt("e23", 10)); // Output: NaN

// Use parseFloat when reading a number out of a string
